...
<h2 style="text-align: center;"><br><br>All Upcoming Events Will Be Shown Here</h2><br><br>
<div class="spt">
<form action="searchEvents.php" method="post">
  <input class="input-field" type="text" name="id" placeholder="Search Event by EventID" required>
...
<?php
    ...
    <pre>Event No : '. ++$i .'                                                                   <button><a href="remind.php?param1='.$id.'" class="tmp">Invite</a></button> <button><a href="eventRegistration0.php?param1='.$id.' " style="text-decoration: none; color: red;">'.$tmp.'</a></button> <a href="showRegistrants.php?param1='.$id.' ">'.$cnt.'</a>
          </pre>
					</th>
					</tr>
					<tr>
          ...
          <h4 style="color:red">Registration fee: '.$fee.'<br>Registration closing date: '.$reg_close.'<br></h4>
					</td>
					<td class="tmp">
  					'.$row["des"].'<br>
  					</td>
