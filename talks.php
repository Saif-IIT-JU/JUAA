...
if(!$conn){
  ...
  $output = "";
	while($row=mysqli_fetch_assoc($res)){
		...
		if($authore==$uname && $recipient==$recp){
			...
			$tmp = '
				...
				<style>
					...
					<td class="tmp2">
          <h4>Authore</h4><br>
					<img src="photo/'.$pic.'" style = "height: 90px; width: 90px;"  class="img-thumbnail" /><br>
          			<a href="tmprofile.php?param1='.$authore.' ">'.$authore.'</a><br>
					</td>
					<td>
          <h4>Recipient</h4><br>
					<img src="photo/'.$pic2.'" style = "height: 90px; width: 90px;"  class="img-thumbnail" /><br>
          ...
          '.$msg.'<br>
					...
					<td>
  					...
  					<a href="SendMessage.php?param1='.$recipient.' ">reply</a>
