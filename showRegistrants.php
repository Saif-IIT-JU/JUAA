...
<?php
		...
		if(!$conn){
			...
			//echo "Connect successfully <br>";
				$sql = "SELECT * FROM eventregistrants WHERE event_id='".$id."' ";
				$res = mysqli_query($conn, $sql);
			

				echo "<br><br><h2 style='text-align:center;'>Registered Members For The Event</h2><br><br>";
				$i = 0;
          ...
          $color = $row["color"];
          $tmp_name = $row["name"];
          $sqll = "SELECT * FROM members WHERE uname='".$uname."' ";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
          ...
          T-shirt color: '.$color.'<br>
          T-shirt name: '.$tmp_name.'<br>
					</td>
					<td class="tmp">
