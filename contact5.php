...
<div class="dropdown">
  ...
  <form  class="example" action="searchMembers2.php" method="post" style="margin-left:500px;margin-right:500px ";max-width:300px" >
  <input type="text" placeholder="eg:- 46" name="batch" required>
