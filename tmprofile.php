...
<?php
	...
	$conn = mysqli_connect('localhost', 'root', '', 'project');
	$q1 = "SELECT * from members where uname='".$uname."' ";
	...
	<img src="photo/'.$row["img"].'" style = "height: 200px; width: 190px;"  class="img-thumbnail" /><br><br><br><br>
	<a href="SendMessage.php?param1='.$uname.'"><b>Send Message</b></a>
